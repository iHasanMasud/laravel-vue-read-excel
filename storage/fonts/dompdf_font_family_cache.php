<?php return array(
    ...
    'bangla' => array(
        'R' => DOMPDF_FONT_DIR . '/SolaimanLipi',    // regular font
        'B' => DOMPDF_FONT_DIR . '/SolaimanLipi_Bold',       // optional: bold font
        'I' => DOMPDF_FONT_DIR . '/SolaimanLipi',     // optional: italic font
        'BI' => DOMPDF_FONT_DIR . '/SolaimanLipi', // optional: bold-italic font
        'useOTL' => 0xFF,
        'useKashida' => 75,
    )
) ?>
